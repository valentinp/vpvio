...
%This function was generated by loadlibrary.m parser version 1.1.6.32 on Thu Dec  5 22:03:32 2013
...
fcns.name{fcnNum}='simxSetJointPosition'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}='int32'; fcns.RHS{fcnNum}={'int32', 'int32', 'single', 'int32'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='simxSetJointTargetVelocity'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}='int32'; fcns.RHS{fcnNum}={'int32', 'int32', 'single', 'int32'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='simxSetJointTargetPosition'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}='int32'; fcns.RHS{fcnNum}={'int32', 'int32', 'single', 'int32'};fcnNum=fcnNum+1;
% extern  simxInt simxJointGetForce ( simxInt clientID , simxInt jointHandle , simxFloat * force , simxInt operationMode ); 
fcns.name{fcnNum}='simxJointGetForce'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}='int32'; fcns.RHS{fcnNum}={'int32', 'int32', 'singlePtr', 'int32'};fcnNum=fcnNum+1;
% extern  simxInt simxSetJointForce ( simxInt clientID , simxInt jointHandle , simxFloat force , simxInt operationMode ); 
fcns.name{fcnNum}='simxSetJointForce'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}='int32'; fcns.RHS{fcnNum}={'int32', 'int32', 'single', 'int32'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='simxReadProximitySensor'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}='int32'; fcns.RHS{fcnNum}={'int32', 'int32', 'uint8Ptr', 'singlePtr', 'int32Ptr', 'singlePtr', 'int32'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='simxAuxiliaryConsoleOpen'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}='int32'; fcns.RHS{fcnNum}={'int32', 'int8Ptr', 'int32', 'int32', 'int32Ptr', 'int32Ptr', 'singlePtr', 'singlePtr', 'int32Ptr', 'int32'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='simxSetFloatingParameter'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}='int32'; fcns.RHS{fcnNum}={'int32', 'int32', 'single', 'int32'};fcnNum=fcnNum+1;
...
% extern  simxInt simxDisplayDialog ( simxInt clientID , const simxChar * titleText , const simxChar * mainText , simxInt dialogType , const simxChar * initialText , simxFloat * titleColors , simxFloat * dialogColors , simxInt * dialogHandle , simxInt * uiHandle , simxInt operationMode ); 
fcns.name{fcnNum}='simxDisplayDialog'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}='int32'; fcns.RHS{fcnNum}={'int32', 'int8Ptr', 'int8Ptr', 'int32', 'int8Ptr', 'singlePtr', 'singlePtr', 'int32Ptr', 'int32Ptr', 'int32'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='simxSetFloatSignal'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}='int32'; fcns.RHS{fcnNum}={'int32', 'int8Ptr', 'single', 'int32'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='simxSetObjectFloatParameter'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}='int32'; fcns.RHS{fcnNum}={'int32', 'int32', 'int32', 'single', 'int32'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='simxCreateDummy'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}='int32'; fcns.RHS{fcnNum}={'int32', 'single', 'uint8Ptr', 'int32Ptr', 'int32'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='simxQuery'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}='int32'; fcns.RHS{fcnNum}={'int32', 'int8Ptr', 'uint8Ptr', 'int32', 'int8Ptr', 'uint8PtrPtr', 'int32Ptr', 'int32'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='simxGetObjectGroupData'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}='int32'; fcns.RHS{fcnNum}={'int32', 'int32', 'int32', 'int32Ptr', 'int32PtrPtr', 'int32Ptr', 'int32PtrPtr', 'int32Ptr', 'singlePtrPtr', 'int32Ptr', 'int8PtrPtr', 'int32'};fcnNum=fcnNum+1;
