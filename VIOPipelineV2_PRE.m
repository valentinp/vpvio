function [T_wcam_estimated,T_wimu_estimated, keyFrames] = VIOPipelineV2_PRE(K, T_camimu, imageMeasurements, imuData, pipelineOptions, noiseParams, xInit, g_w, g2oOptions, T_wcam_GT)
