function [ matchedToAllIndices ] = matchToGlobalLandmarks( matchedRelFeatures, allLandmarkFeatures, allLandmarkPositions_w, pixelMeasurements, K, T_wcam )
%MATCHTOGLOBALLANDMARKS Match local features to a global set using a
%Chi-squared test

        matchedToAllIndices = matchFeatures(matchedRelFeatures, allLandmarkFeatures);
